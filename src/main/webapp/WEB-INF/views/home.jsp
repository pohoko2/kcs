...
<body>
    ...
    <div class="slider">
        <div class="owl-carousel owl-theme">
            <div class="item"> <img src="../resources/images/slider-1.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                <h1 class="slider-title">여기에다가는 <span class="slider-highlight-text">배 그림을 쳐넣어서</span> 
                Master Course</h1>
                                <p class="slider-text hidden-xs">Education for Students Bright Future. </p>
                                <a href="about.html" class="btn btn-default btn-lg hidden-sm hidden-xs"> 예약현황</a> </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="item"><img src="../resources/images/slider-2.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12  col-xs-12">
                            <div class="slider-captions">
...
Students</span></h1>
            ...
            <div class="item"><img src="../resources/images/slider-3.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12  col-xs-12">
                            <div class="slider-captions">
                                <h1 class="slider-title"> 누렁이 쓰고싶은곳 <span class="slider-highlight-text">ㅇ이거는 뭐야~? Experts
Teach You</span></h1>
                                <p class="slider-text hidden-xs">Education for Students Bright Future. </p>
                                <a href="about.html" class="btn btn-default btn-lg  hidden-sm hidden-xs "> 뷰 맞지?</a> </div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="space-medium bg-default pdb150">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="about-img"><img src="../resources/images/about-img.jpg" alt="" class="img-responsive">
                        <div class="about-icon">
                            <a href="#"><img src="../resources/images/play.png"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-section">
                    <div class="team-img">
                        <a href="#"><img src="../resources/images/team-1.jpg" alt="" class="img-circle"></a>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-section">
                    <div class="team-img ">
                        <a href="#"><img src="../resources/images/team-2.jpg" alt="" class="img-circle"></a>
                    </div>
                    <div class="team-content mt20">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-section">
                    <div class="team-img ">
                        <a href="#"><img src="../resources/images/team-3.jpg" alt="" class="img-circle"></a>
                    </div>
                    <div class="team-content mt20">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-section">
                    <div class="team-img ">
                        <a href="#"><img src="../resources/images/team-4.jpg" alt="" class="img-circle"></a>
                    </div>
                    <div class="team-content mt20">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="testimonial-pic"><img src="../resources/images/testi-pic-1.jpg" alt="" class="img-circle"></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="testimonial-pic"><img src="../resources/images/testi-pic-2.jpg" alt="" class="img-circle"></div>
                    <div class="testimonial-user">
                        <h4>Jodi Conner</h4>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="testimonial-pic"><img src="../resources/images/testi-pic-3.jpg" alt="" class="img-circle"></div>
                    <div class="testimonial-user">
                        <h4>Clyde Kirk</h4>
